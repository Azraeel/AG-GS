(function () {
  ...
  const SEED_GEOGRAPHY = {
    ...
    imperial_dynasty_of_saochai: { x: 37.53, y: 49.93, region: "central_west", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    okudan_empire: { x: 28, y: 28, region: "northwest", coastal: true, portStrength: 5, routeAccess: ["ocean", "land"] },
    empire_of_hyeosu: { x: 45.63, y: 49.85, region: "central", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    ...
    talvaskiyan_republic: { x: 61.24, y: 30.16, region: "central", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    orinian_empire: { x: 73, y: 43, region: "east_central", coastal: true, portStrength: 7, routeAccess: ["ocean", "land"] },
    mumoon_hamed_sultunate: { x: 70.65, y: 46.45, region: "east_central", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    empire_of_hanazuki: { x: 41.74, y: 35.49, region: "central", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    baathist_republic_of_volgastan: { x: 82, y: 58, region: "southeast", coastal: true, portStrength: 4, routeAccess: ["ocean", "land"] },
    karkalnadag_kingdom: { x: 86, y: 24, region: "northeast", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    ...
    vorkutangrad: { x: 71.01, y: 18.37, region: "northeast", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    republic_of_borealyan: { x: 58.04, y: 26.19, region: "central", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    judas_democratic_republic: { x: 81.51, y: 29.86, region: "east", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    imperial_suomi: { x: 67.75, y: 26.63, region: "east", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    republic_of_perzam: { x: 25.73, y: 64.61, region: "west", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    federated_syndicates_of_veszprem: { x: 24.3, y: 57.29, region: "west", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    republic_of_calblanca: { x: 56.73, y: 45.23, region: "central", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
    templar_of_saxonia: { x: 4.34, y: 24.91, region: "far_west", coastal: true, landlocked: false, portStrength: 5, routeAccess: ["ocean"] },
  ...
  const SVG_LABEL_BINDINGS = {
    baathist_republic_of_volgastan: "svg_label_314",
    benera_navine: "svg_label_368",
    bingtau_kingdom: "svg_label_292",
    crovian_national_union: "svg_label_1113",
    democratic_republic_of_suzuharu: "svg_label_2776",
    dracoist_malonia: "svg_label_186",
    duchy_of_hoogeveen: "svg_label_1102",
    duchy_of_ledostrov: "svg_label_1014",
    empire_of_hyeosu: "svg_label_441",
    empire_of_khalindar: "svg_label_426",
    federated_syndicates_of_veszprem: "svg_label_489",
    federation_of_vinterholm: "svg_label_523",
    fengu_people_s_federation: "svg_label_1222",
    fuji_shogunate: "svg_label_2668",
    hyelean_republic: "svg_label_216",
    imperial_rhovland: "svg_label_479",
    imperial_suomi: "svg_label_2023",
    judas_democratic_republic: "svg_label_486",
    karkalnadag_kingdom: "svg_label_245",
    khalari_emirates: "svg_label_517",
    kingdom_of_lunaria: "svg_label_487",
    kolkenlennan_empire: "svg_label_439",
    mumoon_hamed_sultunate: "svg_label_516",
    okudan_empire: "svg_label_231",
    orinian_empire: "svg_label_501",
    pdr_of_hoshigoru: "svg_label_1013",
    people_s_republic_of_mariposa: "svg_label_1104",
    republic_of_aurendale: "svg_label_1489",
    republic_of_belcanto: "svg_label_962",
    republic_of_borealyan: "svg_label_1864",
    republic_of_calblanca: "svg_label_232",
    republic_of_perzam: "svg_label_229",
    republic_of_pestera: "svg_label_448",
    republic_of_shangri_la: "svg_label_1727",
    serranova_military_junta: "svg_label_464",
    solara: "svg_label_301",
    surnovska_republic: "svg_label_474",
    templar_of_saxonia: "svg_label_820",
    theorin_commonwealth: "svg_label_2039",
    tsardom_of_nogoyev: "svg_label_1425",
    vesperan_federation: "svg_label_1136",
    vinraarabeise_people_s_republic: "svg_label_194",
    vorkutangrad: "svg_label_281",
    zhensanovian_commonwealth: "svg_label_474"
  };
  ...
  const SVG_TERRITORY_BINDINGS = {
    ...
    benera_navine: { sourceId: "svg_path_89" },
    bingtau_kingdom: { x: 56.8, y: 25.9, pathX: 56.8, pathY: 25.9, width: 2.6, height: 2.2, useRoundedBox: true },
    butonian_state: { sourceId: "svg_path_45" },
    crovian_national_union: { sourceId: "svg_path_48" },
    democratic_republic_of_suzuharu: { sourceId: "svg_path_30" },
    dracoist_malonia: { sourceId: "svg_path_39" },
    duchy_of_hoogeveen: { sourceId: "svg_path_87" },
    duchy_of_ledostrov: { sourceId: "svg_path_56" },
    empire_of_hanazuki: { sourceId: "svg_path_41" },
    empire_of_hyeosu: { sourceId: "svg_path_27" },
    ...
    federation_of_vinterholm: { sourceId: "svg_path_31" },
    fengu_people_s_federation: { sourceId: "svg_path_108" },
    fuji_shogunate: { sourceId: "svg_path_134", width: 2.6, height: 1.8, useRoundedBox: true },
    hyelean_republic: { x: 96.6, y: 44.5, pathX: 96.6, pathY: 44.5, width: 5, height: 2.4, useRoundedBox: true },
    imperial_dynasty_of_saochai: { sourceId: "svg_path_11" },
    imperial_rhovland: { sourceId: "svg_path_16" },
    imperial_suomi: { sourceId: "svg_path_43" },
    judas_democratic_republic: { sourceId: "svg_path_38" },
    karkalnadag_kingdom: { sourceId: "svg_path_9" },
    khalari_emirates: { sourceId: "svg_path_68" },
    kingdom_of_lunaria: { sourceId: "svg_path_29" },
    kolkenlennan_empire: { sourceId: "svg_path_63" },
    talvaskiyan_republic: { sourceId: "svg_path_126" },
    ...
    people_s_republic_of_mariposa: { sourceId: "svg_path_25" },
    republic_of_aurendale: { sourceId: "svg_path_93" },
    republic_of_belcanto: { x: 53.0, y: 9.0, pathX: 53.0, pathY: 9.0, width: 4.6, height: 2.2, useRoundedBox: true },
    republic_of_borealyan: { sourceId: "svg_path_69" },
    republic_of_calblanca: { sourceId: "svg_path_77" },
    republic_of_perzam: { sourceId: "svg_path_53" },
    republic_of_pestera: { sourceId: "svg_path_28" },
    republic_of_shangri_la: { sourceId: "svg_path_94" },
    serranova_military_junta: { sourceId: "svg_path_37" },
    solara: { sourceId: "svg_path_19" },
    templar_of_saxonia: { sourceId: "svg_path_84" },
    theorin_commonwealth: { sourceId: "svg_path_26" },
    tsardom_of_nogoyev: { sourceId: "svg_path_35" },
    vesperan_federation: { sourceId: "svg_path_23" },
